...
%----------HEADING-----------------
\parbox{2.35cm}{%
% Intentionally left empty in the original, can be used for a logo if desired
% \includegraphics[width=2cm]{logo.png} % Example if a logo is to be added
}
...
\section{Experience} % Removed \textbf{}
\vspace{-0.4mm}
...
\section{Projects} % Removed \textbf{}
\vspace{-0.4mm}
\resumeSubHeadingListStart
...
\section{Certifications} % Removed \textbf{}
\vspace{-0.4mm}
\resumeSubHeadingListStart
\resumePOR
...
%-----------ACHIEVEMENTS-----------------
\section{Achievements} % Removed \textbf{}
\vspace{-0.2mm}
\resumeSubHeadingListStart
...
\section{Positions of Responsibility} % Removed \textbf{}
\vspace{-0.4mm}
\resumeSubHeadingListStart
